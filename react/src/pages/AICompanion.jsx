  ...
  const [messages, setMessages] = useState([
    {
      id: 1,
      sender: 'ai',
      content: "Hi! Paste an image, upload a document, or ask me anything."
    }
  ]);
    ...
    <div className="bg-[#121212] text-white min-h-screen flex flex-col">
      ...
      <header className="flex items-center justify-between px-6 sm:px-10 py-4 bg-[#1E1E1E] shadow-md sticky top-0 z-50 rounded-b-xl">
        ...
        <nav className="space-x-6 text-lg">
          ...
          <Link to="/ai-companion" className="hover:text-[#62E0A1] transition border-b-2 border-[#24d0a4] pb-1">AI Companion</Link>
